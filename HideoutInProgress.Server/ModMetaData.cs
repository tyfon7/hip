...
{
    public string ModGuid { get; init; } = "com.tyfon.hideoutinprogress";
    public string Name { get; init; } = "Hideout In Progress";
    ...
    public string Url { get; init; } = "https://github.com/tyfon7/hip";
